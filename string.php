...
<body>
    ...
    <?php   
        ...
        */
        ...
        echo "Panjang String :";
     	echo strlen ($first_sentence) . "<br>" . "Jumlah Kata :" . str_word_count($first_sentence) . "<br><br>";

        echo $second_sentence . "<br>";
        echo "Panjang String :";
     	echo strlen ($second_sentence) . "<br>" . "Jumlah Kata : " . str_word_count($second_sentence);
